...
class MainNet(nn.Module):
    def __init__(self, proposalN=None, num_classes=None, channels=None):
        ...
        self.model = tiny_vit_21m_224(pretrained=True,num_classes=num_classes)
...
#             print('patch', patch.shape)
#             print(patch.flatten())
            a = torch.mean(patch.flatten()) * 0.200
#             print('a',a.shape)
...
#             print('m',M[item].shape)
        ...
        out2, weights = self.model(local_imgs.detach(),key='hhj')
...
#         if batch_idx > 1489:
# #             writer.add_images('images', x, 0)
#             writer.add_images('images', local_imgs, batch_idx - 1490)   
