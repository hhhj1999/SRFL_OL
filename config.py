...
if set == 'CUB':
    ...
    root = '/public/home/jd_wgc/zsj_boom/CUB_200_2011'  # dataset path
    num_classes = 200
    ...
    if set == 'CAR':
        ...
        root = '/public/home/jd_wgc/zsj_boom/Stanford_Cars'  # dataset path
        num_classes = 196
    elif set == 'Aircraft':
        model_path = './checkpoint/aircraft'      # pth save path
        root = '/public/home/jd_wgc/zsj_boom/FGVC-aircraft'  # dataset path
        num_classes = 100
    elif set == 'Dog':
        model_path = './checkpoint/dog'      # pth save path
        root = '/public/home/jd_wgc/zsj_boom/dog'  # dataset path
        num_classes = 120
    elif set == 'NA':
        model_path = './checkpoint/NA'      # pth save path
        root = '/public/home/jd_wgc/zsj_boom/dog'  # dataset path
        num_classes = 400
'''indice2coordinates'''
